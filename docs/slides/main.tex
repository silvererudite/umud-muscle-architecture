...
%    5 scale + geometry 1:55     10 closing ......... 4:40
%==============================================================================
...
%--------------------------------------------------------------------- 5 ----
\begin{frame}{Recovering physical scale}
  \begin{columns}[T]
...
%--------------------------------------------------------------------- 6 ----
\begin{frame}{Geometry: from masks to millimetres}
  \begin{columns}[T]
...
%--------------------------------------------------------------------- 9 ----
\begin{frame}{Three of four proposed mechanisms did not earn their place}
  \vspace{0.15cm}
  {\small
